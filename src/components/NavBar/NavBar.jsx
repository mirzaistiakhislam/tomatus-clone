        ...
        <div className="navbar bg-base-100 mb-2">
            <div className="navbar-start">
                <div className="md:w-2/5 flex justify-between">
                    ...
                    <label htmlFor={htmlFor} className="btn bg-base-100 drawer-button border-0">
                        <RxHamburgerMenu />
                    </label>
                </div>
                {/* divider  */}
                ...
                <div className="relative flex items-center">
                    <input type="text" placeholder="Search..." className="input  rounded-full md:h-10 md:w-64 bg-base-200 hidden md:inline" />
                    <button className="hidden md:inline btn btn-ghost btn-circle absolute right-1">
